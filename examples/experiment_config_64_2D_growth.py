...
def get_system_config():
    ...
    system_config.SX = int(64)
    system_config.SY = int(64)
    system_config.SZ = int(1)
...
def get_initialization_space_config():
    ...
    initialization_space_config.occupation_ratio_low = float(0.3)
    initialization_space_config.occupation_ratio_high = float(0.3)
...
def get_update_rule_space_config():
    ...
    # R
    update_rule_space_config.RX_max = int(10)
    update_rule_space_config.RY_max = int(10)
    update_rule_space_config.RZ_max = int(1)
...
def get_representation_config():
    ...
    if representation_cls.__name__ in ["ImageStatisticsRepresentation", "HistogramBlocksRepresentation"]:
        ...
        representation_config.network.parameters = {"input_size": (64,64), "n_channels": 3, "n_latents": 16, "n_conv_layers": 4, "feature_layer": 2, "hidden_channels": 8, "hidden_dim": None,  "encoder_conditional_type": "gaussian"}
