...
def get_system_config():
    ...
    system_config.SX = int(32)
    system_config.SY = int(32)
...
def get_update_rule_space_config():
    ...
    # R
    update_rule_space_config.RX_max = int(7)
    update_rule_space_config.RY_max = int(7)
...
def get_representation_config():
    ...
    if representation_cls.__name__ in ["ImageStatisticsRepresentation", "HistogramBlocksRepresentation"]:
        ...
        representation_config.network.parameters = {"input_size": (32,32), "n_channels": 3, "n_latents": 8, "n_conv_layers": 3, "feature_layer": 1, "hidden_channels": 8, "hidden_dim": None,  "encoder_conditional_type": "gaussian"}
