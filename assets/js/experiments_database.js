        ...
        $(document).ready(function(){
            ...
            for(i = 48; i > 0; i--){
                $("#show_result").append(
                    "<div class='evocraft_img' id='img_"+ (i-1) + "' style='display:inline-block;text-align:center'>"+
        ...
        function displayImagesWithClassFromNumber(start_from_image, image_map_for_class){
            ...
            for(i = 1; i <= 48; i++){
                ...
                $("#img_"+(i-1)+" img").attr('src',"https://mayalenE.github.io/evocraftsearch/assets/experiments/"+ $("#experiment").val() +  "/repetition_" + pad( $("#repetition").val(),6) +"/images/" +  (image_number)  +"_end.png");
